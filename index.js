...
class Student extends Lambdasian{
  constructor(alumni) {
    super(alumni);
    this.previousBackground = alumni.previousBackground;
    this.className = alumni.className;
    this.favSubjects = alumni.favSubjects;
  }
  listSubjects(){
  ...
  sprintChallenge(subject){
    return `${this.name} has begun srint challenge on ${subject}`
  }
}
